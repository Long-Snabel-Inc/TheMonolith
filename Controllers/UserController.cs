...
public class UserController : ControllerBase
{
    ...
    public UserController(ServiceOptions serviceOptions, UserRepository userRepository, ScoreRepository scoreRepository, ILogger<UserController> logger)
    {
    ...
    private async void JudgeFromGoogle(User user)
    {
        ...
        start.Arguments = $@"C:\repos\LongSnabel\Maratus\main.py ""{user.FullName}""";
        start.WorkingDirectory = @"C:\repos\LongSnabel\Maratus";
        ...
        using (Process process = Process.Start(start))
        {
            using (StreamReader reader = process.StandardOutput)
            {
                ...
                float result = float.Parse(strRes, CultureInfo.InvariantCulture); // Here is the result of StdOut(for example: print "test")
                await _scoreRepository.Create(new Score(user, "GOOGLETEXT", result));
            }
        }
    }
}
